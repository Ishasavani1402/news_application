...
class Bitcoindetail extends StatefulWidget{
  String image;
  String discription;
  String source;
  String author;
  ...
  String published;
  String content;
  Bitcoindetail({required this.image,
  ...
  @override
  State<StatefulWidget> createState() => _BitcoindetailState();
}
class _BitcoindetailState extends State<Bitcoindetail>{
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("BitcoinDetails",style: TextStyle(fontSize: 20,fontFamily: "bold"),),
      ),
